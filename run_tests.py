...
class TestRunner:
    """Test runner for executing different test suites - Shishir's implementation"""
    ...
    def run_smoke_tests(self, browser="chrome", headless=False, parallel=False):
        """Run smoke tests - the most important tests"""
...
def main():
    ...
    try:
        ...
        if success:
            logger.info("Test execution completed succesfully")
            sys.exit(0)
        else:
