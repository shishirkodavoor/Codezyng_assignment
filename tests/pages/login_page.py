"""
Login Page Object Model - Created by Shishir
"""
...
class LoginPage(BasePage):
    """Login page class - Shishir's implementation"""
    
    # Locators - these are the element selectors
    ...
    def navigate_to_login_page(self):
        """Navigate to login page - Shishir's method"""
        try:
