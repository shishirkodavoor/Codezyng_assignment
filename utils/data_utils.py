"""
Data utilities for handling Excel, CSV, and JSON data - Created by Shishir
"""
import pandas as pd
import json
import csv
...
class DataUtils:
    """Utility class for handling test data from various sources - Shishir's implementation"""
    ...
    def read_excel_data(self, file_path: str, sheet_name: str = None) -> List[Dict[str, Any]]:
        """Read data from Excel file - Rajesh's method"""
        try:
